...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i383.GetCommentByIdUseCase>(() => _i383.GetCommentByIdUseCase(
        postRepositoryBase: gh<_i829.PostRepositoryBase>()));
    gh.factory<_i230.GetPostUseCase>(() => _i230.GetPostUseCase(
        postRepositoryBase: gh<_i829.PostRepositoryBase>()));
    gh.factory<_i207.PostBloc>(() => _i207.PostBloc(
          getPostUseCase: gh<_i230.GetPostUseCase>(),
          getCommentByIdUseCase: gh<_i383.GetCommentByIdUseCase>(),
        ));
    return this;
  }
}
